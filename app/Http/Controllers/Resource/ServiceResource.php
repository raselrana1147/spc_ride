...
class ServiceResource extends Controller
{
    ...
    public function edit($id)
    {
        ...
        /*  echo "<pre>";
            ...
            return view('admin.service.edit',compact('service','Peakhour','geofencing'));
        } catch (ModelNotFoundException $e) {
            return back()->with('flash_error', trans('admin.service_type_msgs.service_type_not_found'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // $prices = ServiceTypeGeoFencings::where('service_type_id',$id)->get();

            // foreach ($prices as $key => $geo_price) {

            //     ServiceTypeGeoFencings::where('service_type_id', $id)->update(['fixed' => $request->fixed]);
