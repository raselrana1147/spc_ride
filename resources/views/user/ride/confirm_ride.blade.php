        ...
        <div class="row no-margin">
            <div class="col-md-6">
                ...
                {{ csrf_field() }}
                    ...
                    <input type="hidden" name="fare" value="{{$fare->estimated_fare}}">
                    ...
                    <input type="hidden" name="geo_fencing_id" value="{{$fare->geo_fencing_id}}">
                    ...
                    <select class="form-control" name="payment_mode" id="payment_mode" onchange="card(this.value);">
                      ...
                      @if(Config::get('constants.wallet') == 1)
    ...
    <script type="text/javascript">
        ...
        function card(value){
            ...
            if(value == 'CARD'){
              ...
              if(estimate > wallet){
                alert("Your balce is very low to take this ride, Please choose another payment.");
