...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.geo-fencing.store')}}" method="POST" enctype="multipart/form-data" role="form">
                {{ csrf_field() }}
...
<script>
    ...
    function initMap() {
        ...
        var userLocation = new google.maps.LatLng(14.716677, -17.467686);

        var originInput = document.getElementById('city_name');
    ...
    //map.setupPlaceChangedListener(originAutocomplete, 'ORIG');
