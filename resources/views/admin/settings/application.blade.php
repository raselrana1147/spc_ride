  ...
  <div class="tab-content" id="myTabContent">
				...
				<div class="form-group row">
					...
					<div class="col-xs-9">
						<select class="form-control" id="timezone" name="timezone" autocomplete="off">
							...
							<!-- <option value="Africa/Dakar" @if(Config::get('constants.timezone') == 'Africa/Dakar') selected @endif>Africa/Dakar</option> -->
							<option value="Europe/Amsterdam" @if(Config::get('constants.timezone') == 'Europe/Amsterdam') selected @endif>Europe/Amsterdam</option>
    ...
    <div class="form-box row">
    		<div class="col-md-10">
				...
				<div class="form-group row">
					<label for="twilio_accountsid" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_accountsid')</label>
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ Config::get('constants.twilio_accountsid')  }}" name="twilio_accountsid" required id="twilio_accountsid" placeholder="@lang('admin.setting.twilio_accountsid')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_token" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_token')</label>
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ Config::get('constants.twilio_token')  }}" name="twilio_token" required id="twilio_token" placeholder="@lang('admin.setting.twilio_token')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_key" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_key')</label>
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ Config::get('constants.twilio_key')  }}" name="twilio_key" required id="twilio_key" placeholder="@lang('admin.setting.twilio_key')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_secret" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_secret')</label>
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ Config::get('constants.twilio_secret')  }}" name="twilio_secret" required id="twilio_secret" placeholder="@lang('admin.setting.twilio_secret')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_app_sid" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_app_sid')</label>
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ Config::get('constants.twilio_app_sid')  }}" name="twilio_app_sid" required id="twilio_app_sid" placeholder="@lang('admin.setting.twilio_app_sid')">
					</div>
				</div>

				<div class="form-group row">
					<label for="twilio_mobile" class="col-xs-3 col-form-label">@lang('admin.setting.twilio_mobile')</label>
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ Config::get('constants.twilio_mobile')  }}" name="twilio_mobile" required id="twilio_mobile" placeholder="@lang('admin.setting.twilio_mobile')">
					</div>
				</div>
				<div class="form-group row">
					<label for="zipcode" class="col-xs-2 col-form-label"></label>
				...
				<div class="form-group row">
					...
					<div class="col-xs-9">
						<select name="environment" required id="environment" class="form-control">
							<option value="development" @if(config('onstants.environment') == 'development') selected @endif>Development</option>
							<option value="production" @if(config('onstants.environment') == 'production') selected @endif>Production</option>
						</select>
					</div>
				</div>
    ...
    <div class="tab-pane fade " id="others" role="tabpanel" aria-labelledby="others-tab" aria-expanded="false">
   		<div class="form-box row">
    		<div class="col-md-10">
                ...
                <option @if(config('constants.currency') == "৳") selected @endif value="৳">Bangladeshi taka (BDT)</option>
                                    ...
                                    <option @if(config('constants.currency') == "FCFA") selected @endif value="FCFA"> France (FCFA)</option>
                                    <option @if(config('constants.currency') == "Bs") selected @endif value="Bs"> Bolivian Boliviano (BOB)</option>
                                </select>
                            </div>
                        </div>
						@if(Setting::get('demo_mode', 0) != 1)
