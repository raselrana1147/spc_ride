    ...
    <div role="tabpanel" class="tab-pane fade active in" id="paymentMode" aria-labelledby="home-tab" aria-expanded="true">
    	<div class="form-box row">
            ...
            <form action="{{route('admin.settings.payment.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="payment_settings" @if(config('constants.card') == 0) style="display: none;" @endif>
                           ...
                           <label for="stripe_oauth_url" class="col-xs-4 col-form-label">Stripe Oauth Url</label>
                                  ...
                                  <div class="col-xs-8">
                                    ...
                                    <input class="form-control" type="text" value="{{ config('constants.stripe_oauth_url') }}" name="stripe_oauth_url" id="stripe_oauth_url"  placeholder="Stripe Oauth Url">
                ...
                <div class="card card-block card-inverse card-primary">
                    <blockquote class="card-blockquote">
                        <i class="fa fa-3x fa-google-wallet pull-right"></i>
                        <div class="form-group row">
                            <div class="col-xs-4 arabic_right">
                                <label for="cash-payments" class="col-form-label">
                                   Wallet 
                            ...
                            <div class="col-xs-6">
                                <input @if(config('constants.wallet') == 1) checked  @endif autocomplete="off" name="wallet" id="wallet-payments" type="checkbox" class="js-switch" data-color="#43b968">
                            </div>
                        </div>
                    </blockquote>
                </div>
