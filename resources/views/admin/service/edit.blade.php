                                ...
                                <?php
                                 ...
                                 ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" type="number" value="{{@$service_fencing['fixed']  ? @$service_fencing['fixed'] : 0 }}" min="0" name="geo_fencing[{{$data->id}}][fixed]" placeholder="Minutes Price"/></td> 
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
